...
public class SecurityConfig {
	private final UserDetailsSV userDetailsSV;
	private final JWTAuthFilter jwtAuthFilter;
	private final CustomAccessDeniedHandler accessDeniedHandler;
	private final CustomAuthenticationEntryPoint authenticationEntryPoint;
	
	public SecurityConfig(UserDetailsSV userDetailsSV, JWTAuthFilter jwtAuthFilter,
			CustomAccessDeniedHandler accessDeniedHandler, CustomAuthenticationEntryPoint authenticationEntryPoint) {
		super();
		this.userDetailsSV = userDetailsSV;
