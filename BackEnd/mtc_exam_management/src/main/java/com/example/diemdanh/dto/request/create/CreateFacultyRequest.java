...
public class CreateFacultyRequest {
    ...
    @Schema(example = "Faculty Example")
	...
	public CreateFacultyRequest(
			@NotBlank(message = "Class name is required") @Size(max = 150, message = "Faculty name must not exceed 150 characters") String strFacultyName,
